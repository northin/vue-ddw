<template lang="html">
  <div class="">
    ...
    <div class="" style="height: 87vh;overflow: auto;">
      <div class="" >
        ...
        <swiper :show-dots="false" height="600px">
    ...
    <div class="buy-div" style="display:flex">
      <div class="" style="width:15%" @click="collection">
        ...
        <div style="font-size: 12px;padding-top: 20px;padding-left: 12px;">收藏</div>
      </div>
      <div class="" style="width:18%" @click="linkCart">
        <i class="fa fa-shopping-cart" style="position:absolute;top:5px;"  aria-hidden="true"></i>
        <div style="font-size: 12px;padding-top: 20px;padding-left: 14px;">购物车</div>
